                                 ...
                                 reduce_data,reduce_func,lck)
{
    ...
    arg2 = _malloc(4);
    HEAP32[arg1>>2] = 4288;
    HEAP32[arg2>>2] = HEAP32[reduce_data>>2];
    */

    //argarr=[reduce_data-loc,reduce_data];
    //Module.print(argarr);
    //Module.print(HEAP32[HEAP32[reduce_data>>2]>>2]);
    //Module.print(HEAP32[HEAP32[arg1>>2]>>2]);
    //Module.print(HEAP32[HEAP32[arg2>>2]>>2]);
    /*
    var stack = Runtime.stackSave();
    Runtime.dynCall('v'+'i'.repeat(argarr.length), reduce_func,argarr);
